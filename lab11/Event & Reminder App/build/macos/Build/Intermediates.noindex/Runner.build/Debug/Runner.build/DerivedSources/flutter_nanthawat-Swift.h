...
#ifndef FLUTTER_NANTHAWAT_SWIFT_H
#define FLUTTER_NANTHAWAT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_nanthawat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC17flutter_nanthawat11AppDelegate")
...
SWIFT_CLASS("_TtC17flutter_nanthawat17MainFlutterWindow")
